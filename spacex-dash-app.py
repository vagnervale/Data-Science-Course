...
def get_charts(entered_site,payload):
    ...
    if entered_site == 'ALL':
        ...
        fig2 = px.scatter(filtered_df2[filtered_df2['Launch Site']==entered_site], 
        x='Payload Mass (kg)', y='class', 
        color='Booster Version Category',
        title='Correlation between payload and success for chosen site')
        return [fig,fig2]
